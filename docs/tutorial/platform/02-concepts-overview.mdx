...
<Tabs>
  ...
  <TabItem value="Instantiate smart contract">
    ...
    After the transaction has been validated, you can find the smart contract's address in the events, as it looks something like that:
      ...
      ...
      ```
    To understand how the `wasm14hj...` address was created for your smart contract instance, head to the [hello world](./04-hello-world.mdx) where these is a deep-dive named "How was this address computed?".
  </TabItem>
</Tabs>
...
- [MsgStoreCode](https://github.com/CosmWasm/wasmd/blob/v0.53.0/x/wasm/types/tx.pb.go#L40-L48) is used to store a bytecode inside the CosmWasm bytecode store.
  ...
  To see it in action, go to [Store your contract code](./04-hello-world.mdx#store-your-contract-code) part of the [hello world](./04-hello-world.mdx).
- [MsgExecuteContract](https://github.com/CosmWasm/wasmd/blob/v0.53.0/x/wasm/types/tx.pb.go#L342-L351) is used to instruct the CosmWasm
  ...
  To see it in action, go to [Send a transaction to your contract](./04-hello-world.mdx#send-a-transaction-to-your-contract) part of the [hello world](./04-hello-world.mdx).
...
* When a user instructs the CosmWasm module that a smart contract call needs to include a certain **amount of tokens**,
  ...
  ```
  See [the hello world's](./04-hello-world.mdx#send-a-transaction-to-your-contract) _Send a transaction to your contract_ to pass funds along with a contract call,
